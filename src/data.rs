/// * INFO: Use Mutex for thread-safe access to a variable e.g. our DATA data.
use std::{collections::HashMap, sync::Mutex};

/// * INFO: Use once_cell for creating a global variable e.g. our DATA data.
use once_cell::sync::Lazy;

/// * INFO: Bring Book struct into scope
use crate::book::Book;
